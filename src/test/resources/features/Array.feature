...
Feature: Array
  ...
  Scenario Outline: User is able to run python code from Arrays using List and get correct output or error message
  ...
  Scenario Outline: User is able to run python code from Basic Operations in Lists and get correct output or error message
  ...
  Scenario Outline: User is able to run python code from Applications of Array and get correct output or error message
